...
class ReviewAPITestCase(APITestCase):
    """Shared setup for all review API tests."""
...
class ReviewListTests(ReviewAPITestCase):
    ...
    def test_list_reviews_success(self):
        """Authenticated user can list all reviews."""
...
class ReviewCreateTests(ReviewAPITestCase):
    ...
    def test_create_review_success(self):
        """Customer can create review for business user."""
        self.client.credentials(HTTP_AUTHORIZATION=f'Token {self.customer_token.key}')
        data = {
    ...
    def test_create_review_only_customer_can_review(self):
        """Only customer type users can create reviews."""
    ...
    def test_create_review_duplicate_not_allowed(self):
        """User cannot create duplicate review for same business user."""
...
class ReviewUpdateTests(ReviewAPITestCase):
    """Test PATCH /api/reviews/{id}/ endpoint."""
